...
- Tools Used Tool Purpose Microsoft SQL Server Data import, cleaning, and querying Power BI Visualization and dashboard design Excel Preprocessing and restructuring data
